Mount & Blade II Bannerlord - Extension Mod
	...
	Full source code available here: https://github.com/GeluHUN/mb2-bannerlord-mods
	...
	* Encyclopedia changes
	...
	Credits
		...
		* Tweaking the game with Bannerlord Tweaks from mildeww
		* Faster game encounters with Fast Dialogue from Dallen1393
		* Training your troops with Xorberax's Training Field from Xorberax
		* Getting a loan with Xorberax's Banks of Calradia from Xorberax
		* Talking to lords from the encyclopedia with Telepathy from kir58
		* Changing time with Better time from Shemiroth
		* Changing combat parameters with Light Combat Mod Collection from sgsdxzy
		* Changing the time of battle with Let's Battle In The Morning from kisukuy
		* Getting relation increase with Kill Bandits Raise Relations from Clickers2223
		* Faction armories in towns with V's Faction Armouries MindfulDroid
		* Troop collision changes with Troop Collision and siege tower and castle stairs fix Jackthebiatch
		* Shield changes with Realistic Shield Usage from unstableai
		* Hideout troop selection with Hideout Roster from grizmul
		* Battle size change with Battle Size Unlocker petiti06
		* Event warnings with Sound The Alarm from TheWulfPanda
